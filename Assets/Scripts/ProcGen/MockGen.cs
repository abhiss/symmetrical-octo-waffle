...
namespace ProcGen
{
    ...
    public class Generator
    {
        ...
        public void Generate(Config config)
        {
            ...
            Debug.Log("agenttypeid:" + surface.agentTypeID);
        ...
        void GenProps(Room room)
        {
            ...
            for (int i = 0; i < iterations; ++i)
            {
                ...
                SpawnProp(room, _prefabs[(int)Prefab.Turret], _random.Next(0, groundAmt--), true);
                SpawnProp(room, _prefabs[(int)Prefab.Drum], _random.Next(0, groundAmt--));
                SpawnProp(room, _prefabs[(int)Prefab.EnemySpawner], _random.Next(0, groundAmt--), true);
            }
        ...
        void SpawnProp(Room room, GameObject prefab, int groundIndex, bool isSpawnerOrTurret = false)
        {
            ...
            var recursiveNetworkObject = prop.GetComponentInChildren<Unity.Netcode.NetworkObject>();
            if(recursiveNetworkObject is not null) NetworkObjects.Add(recursiveNetworkObject);
